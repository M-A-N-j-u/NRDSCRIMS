...
//     const { teamName, teamLeader, player1, player2, player3, player4, player5 } = formData;
//     const message = `PUBG Registration:\nTeam Name: ${teamName}\nTeam Leader: ${teamLeader}\nPlayers:\n1. ${player1}\n2. ${player2}\n3. ${player3}\n4. ${player4}\n5. ${player5}`;
//     const whatsappURL = `https://wa.me/<8156842631>?text=${encodeURIComponent(message)}`;
...
//         animate={{ opacity: 1 }}
//       >
//         <h2 className="text-2xl font-bold text-green-400">🎉 Submitted Successfully!</h2>
//         <p className="text-white">Check WhatsApp to complete your registration.</p>
//       </motion.div>
//     );
//   }
...
//       {["teamName", "teamLeader", "player1", "player2", "player3", "player4", "player5"].map((field, index) => (
//         <input
//           key={index}
//           type="text"
//           name={field}
